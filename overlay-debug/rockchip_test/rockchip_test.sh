...
npu_stress_test()
{
    bash /rockchip_test/npu/npu_test.sh
}

npu2_stress_test()
{
    bash /rockchip_test/npu2/npu_test.sh
}

ddr_test()
{
    bash /rockchip_test/ddr/ddr_test.sh
}

cpufreq_test()
{
    bash /rockchip_test/cpu/cpufreq_test.sh
}
...
recovery_test()
{
    bash /rockchip_test/recovery_test/auto_reboot.sh
}

suspend_resume_test()
{
    bash /rockchip_test/suspend_resume/suspend_resume.sh
}

wifi_test()
{
    bash /rockchip_test/wifi/wifi_test.sh
}
...
bluetooth_test()
{
    bash /rockchip_test/bluetooth/bt_onoff.sh &
}

audio_test()
{
    bash /rockchip_test/audio/audio_functions_test.sh
}
...
auto_reboot_test()
{
    ...
    bash /rockchip_test/auto_reboot/auto_reboot.sh
}
...
camera_test()
{
    bash /rockchip_test/camera/camera_test.sh
}

video_test()
{
    bash /rockchip_test/video/video_test.sh
}

gpu_test()
{
    bash /rockchip_test/gpu/gpu_test.sh
}

chromium_test()
{
    bash /rockchip_test/chromium/chromium_test.sh
}
...
power_lost_test()
{
        ...
        bash /rockchip_test/flash_test/power_lost_test.sh &
}
