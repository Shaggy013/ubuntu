...
case "$1" in
	...
	su ubuntu -c "DISPLAY=:0.0 /usr/lib/aarch64-linux-gnu/qt5/examples/multimediawidgets/player/player /usr/local/test.mp4 "
	;;
	*)
	export QT_GSTREAMER_WIDGET_VIDEOSINK=rkximagesink
	su ubuntu -c "DISPLAY=:0.0 /usr/lib/arm-linux-gnueabihf/qt5/examples/multimediawidgets/player/player /usr/local/test.mp4 "
	;;
esac
